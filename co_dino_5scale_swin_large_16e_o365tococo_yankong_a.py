...
log_level = 'INFO'
load_from = '/workspace/gaze_tokenize/Co-DETR-main/co_dino_5scale_swin_large_16e_o365tococo.pth'
resume_from = None
workflow = [('train', 1)]
...
model = dict(
    ...
    bbox_head=[
        dict(
            ...
            loss_cls=dict(
                ...
                alpha=0.25,
                loss_weight=24.0),
            loss_bbox=dict(type='GIoULoss', loss_weight=30.0),
    ...
    train_cfg=[
        dict(
            assigner=dict(
                ...
                cls_cost=dict(type='FocalLossCost', weight=3.5),
                reg_cost=dict(
                    type='BBoxL1Cost', weight=1.5, box_format='xywh'),
    ...
    test_cfg=[
        dict(max_per_img=300, nms=dict(type='soft_nms', iou_threshold=1.0)),
        dict(
            rpn=dict(
                nms_pre=1000,
                max_per_img=1000,
...
pretrained = None
work_dir = '/workspace/gaze_tokenize/Co-DETR-main/save/codinoswin_a_loss'
auto_resume = False
gpu_ids = [0]
